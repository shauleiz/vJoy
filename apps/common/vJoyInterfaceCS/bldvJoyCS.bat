...
mkdir %OUTDIR%
"%BUILDER%"  vJoyInterfaceCS.sln  /t:rebuild /p:IntDir=%OUTDIR%;OutDir=%OUTDIR%;Platform="Any CPU";Configuration=Release
goto :eof

:chk_wxp_x86
SET OUTDIR=objchk_wxp_x86\i386\
mkdir %OUTDIR%
"%BUILDER%"  vJoyInterfaceCS.sln  /t:rebuild /p:IntDir=%OUTDIR%;OutDir=%OUTDIR%;Platform="Any CPU";Configuration=Debug
goto :eof
