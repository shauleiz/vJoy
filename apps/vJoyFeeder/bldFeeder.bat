...
mkdir %OUTDIR%
"%BUILDER%"  vjoyfeeder.sln  /t:rebuild /p:OutDir=%OUTDIR%;Platform=Win32;Configuration=Release
goto :eof

:chk_wxp_x86
SET OUTDIR=objchk_wxp_x86\i386\
mkdir %OUTDIR%
"%BUILDER%"  vjoyfeeder.sln  /t:rebuild /p:OutDir=%OUTDIR%;Platform=Win32;Configuration=Debug
goto :eof

:fre_wlh_AMD64
SET OUTDIR=objfre_wlh_amd64\amd64\
mkdir %OUTDIR%
"%BUILDER%"  vjoyfeeder.sln  /t:rebuild /p:OutDir=%OUTDIR%;Platform=x64;Configuration=Release
goto :eof

:chk_wlh_AMD64
SET OUTDIR=objchk_wlh_amd64\amd64\
mkdir %OUTDIR%
"%BUILDER%"  vjoyfeeder.sln  /t:rebuild /p:OutDir=%OUTDIR%;Platform=x64;Configuration=Debug
goto :eof
