...
void vJoyDeviceRemoved(void)
{
	...
	tie.mask = TCIF_IMAGE;
	tie.iImage = -1;
	for (int Id = MAX_N_DEVICES; Id; Id--)
	{
		tie.iImage = (1 + (Id - 1) * 2);
		TabCtrl_SetItem(hTabs, Id - 1, &tie);
	};
...
void UpdateFfbEffectCB(int rID)
{
	...
	int pairs[][2] 
	{ 
		{ IDC_CHK_FFB_CONST, HID_USAGE_CONST }, 
		{ IDC_CHK_FFB_RAMP, HID_USAGE_RAMP }, 
		{ IDC_CHK_FFB_SQUARE, HID_USAGE_SQUR },
		{ IDC_CHK_FFB_SINE, HID_USAGE_SINE },
		{ IDC_CHK_FFB_TRI, HID_USAGE_TRNG },
		{ IDC_CHK_FFB_STUP, HID_USAGE_STUP },
		{ IDC_CHK_FFB_STDN, HID_USAGE_STDN },
		{ IDC_CHK_FFB_SPRING, HID_USAGE_SPRNG },
		{ IDC_CHK_FFB_DAMPER, HID_USAGE_DMPR },
		{ IDC_CHK_FFB_INERTIA, HID_USAGE_INRT },
		{ IDC_CHK_FFB_FRICTION, HID_USAGE_FRIC }
	};
